...
void check_for_jumps(int number){
  if(multiple_jump_check_time != 0 && (inFlag > 1 || midFlag > 1 || (inFlag == midFlag))){
//    Serial.println("checking jumps for multiple people");
//    Serial.print(inFlag);
//    Serial.print(" outFlag: ");
//    Serial.println(outFlag);
    if((millis() - multiple_jump_check_time) <= processing_delay){
      if(number == 1 && multiple_steps[1] != 2){
//        transition = 2;
        multiple_steps[1] = 2;
        Serial.println("jumped to 1");
      }
      
      if(number == 2 && multiple_steps[0] != 1 && jumped_from == 1){
//        transition = 1;
        multiple_steps[0] = 1;
  ...
  else if(multiple_jump_check_time != 0 && (outFlag > 1 || midFlag > 1 || (outFlag == midFlag))){
//    Serial.println("checking jumps for multiple people");
//    Serial.print(inFlag);
//    Serial.print(" outFlag: ");
//    Serial.println(outFlag);
    if((millis() - multiple_jump_check_time) <= processing_delay){
      if(number == 3 && multiple_steps[1] != 2){
//        transition = 2;
        multiple_steps[1] = 2;
        Serial.println("jumped to 3");
      }
      if(number == 2 && multiple_steps[0] != 3 && jumped_from == 3){
//        transition = 3;
        multiple_steps[0] = 3;
...
//  if((inFlag + midFlag + outFlag) > 1 && on_before_off_step > 1){ 
...
void process_multiple_people_scenarios(int number){
  ...
  for(int i = 0;i < 2; i++){
    ...
    if(number == 2 && jumped_from == 1 && steps[0] == 1 && (inFlag > 0 || midFlag > 1 || outFlag > 0)){
    ...
    if(number == 2 && jumped_from == 3 && steps[0] == 3 && (inFlag > 0 || midFlag > 1 || outFlag > 0)){
      Serial.println("single person turning into multiple people");
      if(multiple_steps[0] == 0){
        multiple_steps[0] = 3;
      }
    ...
    if(number == 1 && steps[1] == 2 && (inFlag > 1 || midFlag > 0 || outFlag > 0)){
      Serial.println("single person turning into multiple people");
      if(multiple_steps[0] == 0){
        multiple_steps[0] = 3;
      }
    ...
    if(number == 3 && steps[1] == 2 && (inFlag > 0 || midFlag > 0 || outFlag > 1)){
      Serial.println("single person turning into multiple people");
      if(multiple_steps[0] == 0){
        multiple_steps[0] = 1;
      }
...
//      }
    ...
    if(number == 2 && inFlag >= 1 && jumped_from == 3){
...
//      }
    ...
    if(number == 2 && outFlag >= 1 && jumped_from == 1){
...
//      }
    ...
    if(number == 1 && multiple_steps[0] == 0){
      multiple_steps[0] = number;
      break;
    }
    if(number == 2 && multiple_steps[0] == 1){
    ...
    if(number == 3 && multiple_steps[0] == 0){
      multiple_steps[0] = number;
      break;  
    }
    if(number == 2 && multiple_steps[0] == 3){
      multiple_steps[1] = number;
      break;
    }
    if(number == 1 && multiple_steps[1] == 2){
...
void jump_timer(){
  if(on_before_off_step > 1){
    if((inFlag + midFlag + outFlag) > 1){
      Serial.println("starting multiple-person timer & on before off condition");
      multiple_jump_check_time = millis();
    }
  }
  else if(on_before_off_step == 1){
    if((inFlag + outFlag) == 1){
      Serial.println("single-person timer & on before off condition");
      jump_check_time = millis();
    }
    else if((inFlag + midFlag + outFlag) > 1){
      Serial.println("starting multiple-person timer");
      multiple_jump_check_time = millis();
    }  
  }
  else{
