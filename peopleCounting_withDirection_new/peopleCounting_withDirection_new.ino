...
void check_step_retrospect(int step_number){
  ...
  if(step_number == 1){
    ...
    if(on_step1 >= 0 && weight_sum > onstep1_threshold){
      count++;
...
//        retrospect(1, 'n');
  ...
  //      print_array(1.2);
    ...
    if(on_step1 > 0 && weight_sum < offstep1_threshold){
      count++;
      if(count > COUNT_THRESHOLD){
        on_step1 -= 1;
        people_on_setup = on_step1 + on_step2 + on_step3;
  ...
  if(step_number == 2){
    ...
    if(on_step2 >= 0 && weight_sum > onstep2_threshold){
      count++;
      if(count > COUNT_THRESHOLD){
        on_step2 += 1;
        people_on_setup = on_step1 + on_step2 + on_step3;
...
//        retrospect(2, 'n');
  ...
  //      print_array(2.2);
    ...
    if(on_step2 > 0 && weight_sum < offstep2_threshold){
      count++;
      if(count > COUNT_THRESHOLD){
        on_step2 -= 1;
        people_on_setup = on_step1 + on_step2 + on_step3;
  ...
  if(step_number == 3){
    ...
    if(on_step3 >= 0 && weight_sum > onstep3_threshold){
      count++;
      if(count > COUNT_THRESHOLD){
        on_step3 += 1;
        people_on_setup = on_step1 + on_step2 + on_step3;
...
//        retrospect(3, 'n');
  ...
  //      print_array(3.2);
    ...
    if(on_step3 > 0 && weight_sum < offstep3_threshold){
      count++;
      if(count > COUNT_THRESHOLD){
        on_step3 -= 1;
        people_on_setup = on_step1 + on_step2 + on_step3;
  ...
  for(int i = 0; i < 3; i++){
    ...
    if(i == 0){
      ...
      if(array_content < 2 && ((step_number == 1 && going_in1 == 1)|| (step_number == 3 && going_in3 == 0))){
        Serial.println("number not captured, sacrificing array 1 Array content: " + String(array_content));
        memset(step_array1, 0, sizeof(step_array1));
        step_array1[0] = step_number;
        number_captured = true;
        break;
    ...
    if(i == 1){
      ...
      if(array_content < 2 && ((step_number == 1 && going_in1 == 1)|| (step_number == 3 && going_in3 == 0))){
        Serial.println("number not captured, sacrificing array 2 Array content: " + String(array_content));
        memset(step_array2, 0, sizeof(step_array2));
        step_array2[0] = step_number;
        number_captured = true;
        break;
    ...
    if(i == 2){
      ...
      if(array_content < 2 && ((step_number == 1 && going_in1 == 1)|| (step_number == 3 && going_in3 == 0))){
        Serial.println("number not captured, sacrificing array 3 Array content: " + String(array_content));
        memset(step_array3, 0, sizeof(step_array3));
        step_array3[0] = step_number;
        number_captured = true;
        break;
