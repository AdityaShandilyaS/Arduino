...
bool array1_active = true, array2_active = true, array3_active = true;
int step_array1[3] = {1, 2, 0};
int step_array2[3]  = {3, 0, 0};
int step_array3[3] = {0}; 
...
void loop() {
  ...
  p2_1 = 22 + analogRead(STEP2_1);
  delay(0.1);
  p2_2 = 22 + analogRead(STEP2_2);
  delay(0.1);
