...
float calibration_factor2 = -20000; // -20000 and -15000 perfect CF1 and 2 combo so far
...
void process_step(int number){
    //for multiple person scenarios
    if((inFlag > outFlag && outFlag > 0) || (inFlag < outFlag && inFlag > 0)){
