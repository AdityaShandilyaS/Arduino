...
//      print_array(2);
  ...
  if(on_step2 && weight_sum < (VALUE_PER_PERSON * 0.5)){
    count++;
    if(count > COUNT_THRESHOLD){
      on_step2 = false;
      count = 0;
      retrospect();
      str = "2 f " + String(millis()) + " " + String(going_in) + " " + String(weight_sum);
      Serial.println(str);
//      print_array(2.1);
//      print_array(2.2);
    }  
  ...
  if(step_number == 1){
    ...
    if(!on_step1  && weight > VALUE_PER_PERSON){  
      ...
      if(count > COUNT_THRESHOLD){
        on_step1 = true;
        count = 0;
        str = "1 n " + String(millis()) + " " + "2 " + String(weight);
        Serial.println(str);
//        print_array(step_number);
    ...
    if(on_step1 && weight < (VALUE_PER_PERSON * 0.5)){ 
      ...
      if(count > COUNT_THRESHOLD){      
        on_step1 = false;
        count = 0;
        str = "1 f " + String(millis()) + " " + "2 " + String(weight);
        Serial.println(str);
//        print_array(step_number);
      }      
    }
  ...
  if(step_number == 3){
    ...
    if(!on_step3 && weight > VALUE_PER_PERSON){  
      ...
      if(count > COUNT_THRESHOLD){
        on_step3 = true;
        count = 0;
        str = "3 n " + String(millis()) + " " + "2 " + String(weight);
        Serial.println(str);
//        print_array(step_number);
      }
    }
    if(on_step3 && weight < (VALUE_PER_PERSON * 0.5)){ 
      count ++;
      if(count > COUNT_THRESHOLD){      
        on_step3 = false;
        count = 0;
        str = "3 f " + String(millis()) + " " + "2 " + String(weight);
        Serial.println(str);
//        print_array(step_number);
      }      
    }
